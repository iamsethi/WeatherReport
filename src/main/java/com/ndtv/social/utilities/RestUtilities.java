...
public class RestUtilities {
    ...
    public static RequestSpecification getRequestSpecification(String baseURI, String basePath, String appKey, String city) {
        REQUEST_BUILDER = new RequestSpecBuilder();
        REQUEST_BUILDER.setBaseUri(baseURI);
        REQUEST_BUILDER.setBasePath(basePath);
        REQUEST_BUILDER.addQueryParam("appid", appKey);
        REQUEST_BUILDER.addQueryParam("q", city);
